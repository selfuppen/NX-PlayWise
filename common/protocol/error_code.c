...
static const PtcErrorInfo PTC_ERROR_TABLE[] = {
    ...
    {PTC_ERR_AUTONOMY_DISABLED, "autonomy_disabled", "家长尚未开启今日自主缓冲"},
    {PTC_ERR_DAILY_BUFFER_ALREADY_CLAIMED, "daily_buffer_already_claimed", "今天的自主缓冲已经领取"},
    {PTC_ERR_DAILY_BUFFER_LIMITED_ONLY, "daily_buffer_limited_only", "今日不限时，无法领取自主缓冲"},
    {PTC_ERR_BEDTIME_ACTIVE, "bedtime_active", "当前处于就寝限制时段，不能领取或兑换普通加时"},
    {PTC_ERR_BEDTIME_INSTANCE_NOT_ACTIVE, "bedtime_instance_not_active", "指定的就寝窗口不是当前窗口"},
    {PTC_ERR_BEDTIME_CONFIRMATION_REQUIRED, "bedtime_confirmation_required", "请先确认官方设置和全入口阻断风险"},
    {PTC_ERR_BEDTIME_RECOVERY_FAILED, "bedtime_recovery_failed", "就寝限制恢复失败，请在浮窗中重试或恢复安装前状态"},
    {PTC_ERR_OVERLAY_UNVERIFIED, "overlay_unverified", "浮窗恢复通道尚未验证"},
