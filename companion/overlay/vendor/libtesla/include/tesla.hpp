    ...
    namespace elm {
        ...
        public:
            ...
            virtual void layout(u16 parentX, u16 parentY, u16 parentWidth, u16 parentHeight) override {
                ...
                /* PCTC builds overlays without RTTI. CategoryHeader is a List-only
                   element in libtesla's public UI model, so the checked cast is
                   replaced by the equivalent parent-presence guard. */
                if (List *list = this->getParent() ? static_cast<List*>(this->getParent()) : nullptr; list != nullptr) {
